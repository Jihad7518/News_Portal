...
router.get('/api/news', middleware.auth, newsController.get_dashboard_news); // Route for dashboard news
router.get('/api/news/writer/:writerId', middleware.auth, newsController.get_news_by_writer); // New route for writer-specific news
