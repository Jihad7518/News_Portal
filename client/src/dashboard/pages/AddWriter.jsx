        ...
        <form onSubmit={submit}>
          <div className='grid grid-cols-2 gap-x-8 mb-3'>
            <div className='flex flex-col gap-y-2'>
              ...
              <input onChange={inputHandler} value={state.name} required type='text' placeholder='name' name='name' className='px-3 py-2 rounded-md 
          ...
          <div className='grid grid-col-2 gap-x-8 mb-3'>
            <div className='flex flex-col gap-y-2'>
              ...
              <input onChange={inputHandler} value={state.email} required type='email' placeholder='email' name='email' className='px-3 py-2 rounded-md 
            ...
            <div className='flex flex-col gap-y-2'>
              ...
              <input onChange={inputHandler} value={state.password} required type='password' placeholder='password' name='password' className='px-3 py-2 rounded-md 
